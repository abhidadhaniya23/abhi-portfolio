  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`flex flex-row justify-start items-center rounded-lg  relative bg-cyanPrimary/5 py-3 pl-3 pr-5 w-[16rem] sm:w-[37rem]`}
        >
          ...
          <div className="flex flex-col justify-center items-start pl-4 text-white">
            ...
            <div className="flex flex-row justify-center py-1 items-center">
              <p className="text-xs sm:text-sm font-codeText pr-2">
                {data.subtitle}
              </p>
              {data.link && (
                <Link
