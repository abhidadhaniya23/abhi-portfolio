                    ...
                    <div className="text-xl text-justify md:p-5 md:ml-10 md:-mr-20 md:text-left text-lightBluePrimary">
                        ...
                        <div className="mt-8 text-justify md:mt-5 md:text-left">
                            ...
                            <motion.p variants={animations.p1} initial="initial" animate="animate" exit="exit" className="pl-4 mt-1">
                                <i className="mr-3 text-xs text-cyanPrimary fa-solid fa-diamond"></i>Dealing with API in React.JS.
                            </motion.p>
                            <motion.p variants={animations.p2} initial="initial" animate="animate" exit="exit" className="pl-4 mt-1">
                                <i className="mr-3 text-xs text-cyanPrimary fa-solid fa-diamond"></i>Developing REST APIs using Node.js & Express.js.
                            </motion.p>
                            <motion.p variants={animations.p3} initial="initial" animate="animate" exit="exit" className="pl-4 mt-1">
                                <i className="mr-3 text-xs text-cyanPrimary fa-solid fa-diamond"></i>Authentication with backend and database, using MongoDB.
                            </motion.p>
                        </div>
                    </div>
                </div>
